...
exports.get = async (req, res) => {
  ...
  const matchStr = 'M';
  // matchStr is interpolated into a regex pattern which excludes common irrelevant words (court, family, centre...)
  ...
  try {
    ...
    // getAllCourts fn takes options name == pattern and display == true, and returns name and id, sorted alphabetically
